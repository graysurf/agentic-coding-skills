...
```bash
mkdir -p tests
cp -R "$AGENT_KIT_HOME/skills/api-test-runner/template/setup/api" tests/
cp -R "$AGENT_KIT_HOME/skills/api-test-runner/template/setup/rest" tests/
cp -R "$AGENT_KIT_HOME/skills/api-test-runner/template/setup/graphql" tests/
```
